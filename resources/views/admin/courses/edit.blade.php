            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200">
                ...
                <div class="border-b border-gray-200 bg-gray-50">
                    <nav class="-mb-px flex space-x-8 px-6 overflow-x-auto">
                        ...
                        <button type="button" @click="activeTab = 'students'"
                            ...
                            Studenti (<span x-text="enrolledStudents.length"></span>)
                        </button>
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div :class="{ 'hidden': activeTab !== 'schedule' }" class="space-y-6">
                        ...
                        <button type="button" id="add-schedule-slot" class="w-full px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-rose-300 hover:text-rose-600 transition-colors">
