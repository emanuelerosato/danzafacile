<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        ...
        <li class="flex items-center">
            <a href="{{ route('admin.staff-schedules.show', $staffSchedule) }}" class="text-gray-500 hover:text-gray-700">{{ $staffSchedule->title }}</a>
            <svg class="w-4 h-4 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
        </li>
            ...
            <form method="POST" action="{{ route('admin.staff-schedules.update', $staffSchedule) }}" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                              ...
                              class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-colors duration-200 @error('description') border-red-300 @enderror">{{ old('description', $staffSchedule->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3"
                              ...
                              class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-colors duration-200 @error('notes') border-red-300 @enderror">{{ old('notes', $staffSchedule->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
