...
<div class="container mx-auto px-4 py-6">
    ...
    @if($mediaItems->count() > 0)
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6" id="mediaGrid">
            @foreach($mediaItems as $media)
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden group media-item" data-id="{{ $media->id }}">
                    <!-- Media Preview -->
    ...
    @else
        <!-- Empty State -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 py-16">
