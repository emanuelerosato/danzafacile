    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-500">Registrati</p>
                    <p class="text-lg font-semibold text-gray-900">{{ $stats['registered'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-500">Lista Attesa</p>
                    <p class="text-lg font-semibold text-gray-900">{{ $stats['waitlist'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-500">Annullati</p>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-500">Partecipato</p>
                    <p class="text-lg font-semibold text-gray-900">{{ $stats['attended'] }}</p>
                </div>
            </div>
        </div>
    </div>
...
function applyFilters() {
    ...
    fetch(`{{ route('admin.event-registrations.index') }}?${params.toString()}`, {
        headers: {
    ...
    .then(data => {
        document.getElementById('registrationsTable').innerHTML = data.html;
    })
    .catch(error => {
...
function openAddRegistrationModal() {
    document.getElementById('addRegistrationModal').classList.remove('hidden');
}

function closeAddRegistrationModal() {
    document.getElementById('addRegistrationModal').classList.add('hidden');
...
function submitRegistration(event) {
    ...
    fetch('{{ route('admin.event-registrations.store') }}', {
        method: 'POST',
        headers: {
...
function exportRegistrations() {
    ...
    window.open(`{{ route('admin.event-registrations.export') }}?${params.toString()}`, '_blank');
}

// Close modal on outside click
document.getElementById('addRegistrationModal').addEventListener('click', function(e) {
    if (e.target === this) {
        closeAddRegistrationModal();
    }
});
