...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 mb-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">💬 I Miei Messaggi</h1>
                <p class="text-gray-600">Gestisci le tue richieste di assistenza e comunicazioni con la scuola</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-gradient-to-r from-blue-50 to-blue-100 backdrop-blur-sm rounded-xl p-6 border border-blue-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-blue-600">Totale</p>
                    <p class="text-2xl font-bold text-blue-900">{{ $tickets->total() }}</p>
                </div>
            </div>
        </div>

        <div class="bg-gradient-to-r from-green-50 to-green-100 backdrop-blur-sm rounded-xl p-6 border border-green-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-green-600">Aperti</p>
                    <p class="text-2xl font-bold text-green-900">{{ $tickets->where('status', 'open')->count() }}</p>
                </div>
            </div>
        </div>

        <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 backdrop-blur-sm rounded-xl p-6 border border-yellow-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-yellow-900">{{ $tickets->where('status', 'pending')->count() }}</p>
                </div>
            </div>
        </div>

        <div class="bg-gradient-to-r from-gray-50 to-gray-100 backdrop-blur-sm rounded-xl p-6 border border-gray-200">
            <div class="flex items-center">
