            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    @if(Auth::user()->profile_image_path)
                        <img class="w-12 h-12 rounded-full border-2 border-white shadow"
                             ...
                             alt="{{ Auth::user()->name }}">
                    @else
                        <div class="w-12 h-12 bg-gradient-to-r from-rose-400 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Dashboard Studente - {{ Auth::user()->school->name ?? 'Scuola di Danza' }}
                    </p>
                </div>
            </div>
        </div>
