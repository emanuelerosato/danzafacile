...
@section('title', 'Log Sistema - Super Admin')

@section('content')
<div class="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50" x-data="logsManager()">
    <!-- Header Section -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">📝 Log Sistema</h1>
                        <p class="text-sm text-gray-600">Monitoraggio attività e errori del sistema</p>
                    </div>
                </div>
