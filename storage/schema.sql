...
CREATE TABLE `attendance` (
  ...
  `marked_by_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `attendance_unique` (`user_id`,`attendance_date`),
  UNIQUE KEY `unique_user_course_date` (`user_id`,`course_id`,`attendance_date`),
  UNIQUE KEY `unique_user_event_date` (`user_id`,`event_id`,`attendance_date`),
  KEY `attendance_attendable_type_attendable_id_date_index` (`attendance_date`),
  KEY `attendance_user_id_date_index` (`user_id`,`attendance_date`),
  KEY `attendance_school_id_date_index` (`school_id`,`attendance_date`),
  KEY `attendance_status_date_index` (`status`,`attendance_date`),
  KEY `attendance_marked_by_user_id_foreign` (`marked_by_user_id`),
  KEY `attendance_school_id_attendance_date_index` (`school_id`,`attendance_date`),
  KEY `attendance_user_id_attendance_date_index` (`user_id`,`attendance_date`),
  KEY `attendance_course_id_attendance_date_index` (`course_id`,`attendance_date`),
  KEY `attendance_event_id_attendance_date_index` (`event_id`,`attendance_date`),
  ...
  CONSTRAINT `attendance_marked_by_user_id_foreign` FOREIGN KEY (`marked_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `event_registrations` (
  ...
  `registration_date` datetime NOT NULL DEFAULT '2025-09-14 10:07:30',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2025_09_11_144514_add_missing_fields_to_schools_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2025_09_11_182037_update_role_enum_in_users_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2025_09_12_160551_create_settings_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2025_09_12_210748_create_tickets_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2025_09_12_210817_create_ticket_responses_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2025_09_14_053524_create_events_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2025_09_14_053536_create_event_registrations_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2025_09_14_053550_create_attendance_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2025_09_14_053602_create_staff_roles_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2025_09_14_145605_cleanup_attendance_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2025_09_14_195329_add_advanced_payment_features_to_payments_table',8);
