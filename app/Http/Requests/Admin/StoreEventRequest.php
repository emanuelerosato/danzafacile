...
class StoreEventRequest extends FormRequest
{
    ...
    {
        // L'autorizzazione viene gestita dalla EventPolicy
    ...
    /**
     * Regole di validazione per la creazione di un evento.
     */
    ...
    public function messages(): array
    {
        return [
            ...
            'registration_deadline.after_or_equal' => 'La scadenza registrazioni deve essere oggi o successiva.',
    ...
    /**
     * Ottieni i dati validati con school_id incluso.
     */
    public function validatedWithSchool(): array
    {
        $validated = $this->validated();

        // Aggiungi school_id dell'utente loggato
